...
from users.views import RegisterView, MyTokenObtainPairView, TeamViewSet, ProfileViewSet
...
router.register(r'project/(?P<board_pk>\d+)/board', TaskViewSet, basename='board-tasks')
router.register(r'project/(?P<project_pk>\d+)/team', TeamViewSet, basename='team')
